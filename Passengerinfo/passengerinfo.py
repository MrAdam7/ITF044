...
class PassengerRegistration():
    ...
    def getPassengerInfo(self):
        ...
        if self.dl == 1:
            ...
            self.departureLocation = "Khan Younes"
        elif self.dl == 4:
            self.departureLocation = "Jabalia"
        else:
            print("Please Enter correct choice  :")
        # departure Location Name END

        print("1: Islamic university of Gaza")
        print("2: AL-Azhar university")
        print("3: University of palestine")
        print("4: Gaza University")
        # Enter destination Location Name START
        self.dpl = int(input("Enter Destination Location  :"))
        if self.dpl == 1:
            self.destinationLocation = "Islamic university of Gaza"
        elif self.dpl == 2:
            self.destinationLocation = "University of palestine"
        elif self.dpl == 3:
            self.destinationLocation = "Gaza University"
        elif self.dpl == 4:
            self.destinationLocation = "Bhopal"
        # Enter destination Location Name END

        self.ddmmyyyy = input("Enter Date of Joiurney Like 07-05-2020   :")  #Date of Journey
        ...
        print(" 1. AC BUS     = 30 ILS Fare")
        print(" 2. NON AC BUS = 10 ILS Fare")
